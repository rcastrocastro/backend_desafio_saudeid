...
const CustomerSchema = new mongoose.Schema({
  ...
  birth_date: {
    type: Date,
    require: [true, 'Oops! O campo Data de nascimento é obrigatório.'],
  },
  email: {
    type: String,
    unique: true,
  ...
  sons:{
    ...
    require: [true, 'Oops! É obrigatório selecionar seu se tem filhos.'],
  },
  how_many: {
    type: String,
    possibleValues: ['none', 'one', 'two', 'three', 'More than three'],
    require: [true, 'Oops! É obrigatório selecionar Quantidade de filhos.'],
  },
  address: {
    zip_code: {
      type: String,
